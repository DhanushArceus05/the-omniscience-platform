 ...
 * Message Persistence Foundation) and Phase 6 Step 2 (backend-only
 * authenticated assistant response streaming), backed by a fresh
 ...
 */
describe("Conversations & Messages (e2e, Phase 6 Step 1 & Step 2)", () => {
